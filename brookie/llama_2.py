...
def get_llama_2_instance():
    ...
    print('', Markdown("**My Brookie** will use `Code Llama` for local execution. Use your arrow keys to set up the model."), '')
    ...
    user_data_dir = appdirs.user_data_dir("My Brookie")
