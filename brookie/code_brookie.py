...
language_map = {
  "python": {
    # Python is run from this brookie with sys.executable
...
"""
with open("brookie/forbidden_commands.json", "r") as f:
  ...
  def run(self):
    ...
    for line in self.code.split("\n"):
      if line in forbidden_commands:
        ...
        message += "\n\nPlease contact the My Brookie team if this is an error."
